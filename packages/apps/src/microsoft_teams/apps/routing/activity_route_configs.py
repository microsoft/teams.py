...
ACTIVITY_ROUTES: Dict[str, ActivityConfig] = {
    ...
    "agentic_identity_created": ActivityConfig(
        name="agentic_identity_created",
        method_name="on_agentic_identity_created",
        input_model=AgenticIdentityCreatedActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserIdentityCreated"),
        output_model=None,
    ),
    "agentic_identity_updated": ActivityConfig(
        name="agentic_identity_updated",
        method_name="on_agentic_identity_updated",
        input_model=AgenticIdentityUpdatedActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserIdentityUpdated"),
        output_model=None,
    ),
    "agentic_identity_manager_updated": ActivityConfig(
        name="agentic_identity_manager_updated",
        method_name="on_agentic_identity_manager_updated",
        input_model=AgenticIdentityManagerUpdatedActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserManagerUpdated"),
        output_model=None,
    ),
    "agentic_identity_enabled": ActivityConfig(
        name="agentic_identity_enabled",
        method_name="on_agentic_identity_enabled",
        input_model=AgenticIdentityEnabledActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserEnabled"),
        output_model=None,
    ),
    "agentic_identity_disabled": ActivityConfig(
        name="agentic_identity_disabled",
        method_name="on_agentic_identity_disabled",
        input_model=AgenticIdentityDisabledActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserDisabled"),
        output_model=None,
    ),
    "agentic_identity_deleted": ActivityConfig(
        name="agentic_identity_deleted",
        method_name="on_agentic_identity_deleted",
        input_model=AgenticIdentityDeletedActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserDeleted"),
        output_model=None,
    ),
    "agentic_identity_undeleted": ActivityConfig(
        name="agentic_identity_undeleted",
        method_name="on_agentic_identity_undeleted",
        input_model=AgenticIdentityUndeletedActivity,
        selector=lambda activity: _is_agent_lifecycle_variant(activity, "AgenticUserUndeleted"),
        output_model=None,
    ),
    "agentic_identity_workload_onboarding_updated": ActivityConfig(
        name="agentic_identity_workload_onboarding_updated",
        method_name="on_agentic_identity_workload_onboarding_updated",
        input_model=AgenticIdentityWorkloadOnboardingUpdatedActivity,
